...
export const server = setupServer(
  ...
  http.get('/api/v1/instance/access-keys', () => HttpResponse.json<{ data: Api.AccessKeyOut[] }>({ data: [] })),
  http.get('/api/v1/orgs/:orgId/access-keys', () => HttpResponse.json<{ data: Api.AccessKeyOut[] }>({ data: [] })),
