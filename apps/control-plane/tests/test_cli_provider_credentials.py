"""The credential CLI driven against a real control plane, not a mocked transport.

The commands are the only way a human reaches this feature, so they are tested the way a human uses
them: a typed command in, a real HTTP round trip, a real row and a real secret store behind it.
"""
