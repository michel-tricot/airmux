...
@router.get("/bundles/manifest", dependencies=[require(credential_scope, Permission.bundles_read, traffic_group="operational")])
...
@router.get("/bundles/{bundle_id}", dependencies=[require(selected_bundle_scope, Permission.bundles_read, traffic_group="operational")])
...
@router.get("/bundle/latest", dependencies=[require(bundle_scope, Permission.bundles_read, traffic_group="operational")])
...
@router.post("/events", dependencies=[require(credential_scope, Permission.usage_ingest, traffic_group="operational")])
...
@router.post("/heartbeat", dependencies=[require(credential_scope, Permission.data_planes_heartbeat, traffic_group="operational")])
