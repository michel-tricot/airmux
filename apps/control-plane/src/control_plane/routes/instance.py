...
@router.get("/data-planes", tags=["Data Plane"], dependencies=[require(Permission.data_planes_read, instance_target)])
...
@router.get("/activity", tags=["Activity"], dependencies=[require(Permission.audit_read, instance_target)])
