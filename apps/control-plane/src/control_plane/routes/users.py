...
from control_plane.deps import ActorDep, instance_scope, require, require_all
...
@router.post(
    ...
    tags=["Instance Users"],
    dependencies=[require_all(instance_scope, Permission.principals_manage, Permission.management_keys_issue)],
)
async def issue_instance_service_account_management_key(
    user_id: UUID,
