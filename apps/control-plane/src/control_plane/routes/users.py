...
@router.post("/service-accounts", tags=["Instance Users"], dependencies=[require(Permission.principals_manage, instance_scope)])
...
@router.get("/users/{user_id}", tags=["Instance Users"], dependencies=[require(Permission.principals_read, instance_scope)])
...
@router.delete("/users/{user_id}", tags=["Instance Users"], dependencies=[require(Permission.principals_manage, instance_scope)])
...
@router.get("/users", tags=["Instance Users"], dependencies=[require(Permission.principals_read, instance_scope)])
