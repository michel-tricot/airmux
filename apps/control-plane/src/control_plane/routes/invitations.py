...
@router.post("", tags=["Organization Invitations"], dependencies=[require("api", org_scope, Permission.members_manage)])
...
@router.post(
    ...
    dependencies=[require("api", org_scope, Permission.members_manage)],
)
