...
async def _create_management_key(body: ManagementKeyGrantIn, actor: Actor, scope: Scope) -> Envelope[ManagementKeyMintedOut]:
...
async def create_instance_management_key(body: ManagementKeyGrantIn, actor: ActorDep) -> Envelope[ManagementKeyMintedOut]:
...
async def create_org_management_key(body: ManagementKeyGrantIn, org_id: OrgDep, actor: ActorDep) -> Envelope[ManagementKeyMintedOut]:
