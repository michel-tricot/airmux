...
@router.patch("/{rule_id}", dependencies=[require(workspace_scope, Permission.policies_manage)])
...
@router.delete("/{rule_id}", dependencies=[require(workspace_scope, Permission.policies_manage)])
