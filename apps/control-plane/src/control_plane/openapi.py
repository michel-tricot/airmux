...
OPERATION_SUMMARIES = {
    ...
    "list_org_gateway_requests": "List Organization Requests",
    "list_workspace_gateway_requests": "List Workspace Requests",
    "get_org_gateway_request": "Get Organization Request",
    "get_workspace_gateway_request": "Get Workspace Request",
    "export_org_gateway_requests": "Export Organization Requests",
    "export_workspace_gateway_requests": "Export Workspace Requests",
