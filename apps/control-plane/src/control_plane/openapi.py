...
API_TAGS = [
    ...
    {"name": "Workspaces", "description": "Manage isolated environments within an organization"},
    {"name": "Inference Keys", "description": "Issue and revoke credentials for model requests to a workspace"},
    {"name": "Auth", "description": "Sign in human users, manage browser sessions, and authorize the CLI"},
    {"name": "Enrollment", "description": "List a user's organizations and create their personal organization"},
    {"name": "Bundles", "description": "Compile and inspect signed policy bundles for an organization"},
