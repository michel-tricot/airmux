...
from conformance import _model
...
def test_cache_read_discounted_by_provider_multiplier():
    model = _model("openai_compatible")  # input price 1.0 / Mtok
    usage = Usage(input_tokens=1000, cache_read_tokens=800)  # 200 fresh + 800 cached
