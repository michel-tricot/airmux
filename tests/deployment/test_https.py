...
def https_deployment(tmp_path_factory):
    ...
    gateway = "cli" if compact else "console"
    control_plane = "cli" if compact else "control-plane"
...
def test_internal_plane_ports_are_not_published(https_deployment):
    ...
    services = (control_plane,) if control_plane == "cli" else (control_plane, "data-plane-1", "data-plane-2")
