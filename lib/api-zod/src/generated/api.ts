...
export const getBundleResponsePayloadSchemaVersionDefault = 1;
export const getBundleResponsePayloadCatalogProvidersItemBaseUrlMax = 2083;

export const getBundleResponsePayloadCatalogProvidersItemParamsClosedDefault = false;
export const getBundleResponsePayloadCatalogCredentialsDefault = [];

export const GetBundleResponse = zod.object({
  "payload": zod.object({
  "schema_version": zod.literal(1).default(getBundleResponsePayloadSchemaVersionDefault),
  "bundle_id": zod.uuid(),
  "org_id": zod.uuid(),
  "issued_at": zod.coerce.date(),
  ...
  "base_url": zod.url().min(1).max(getBundleResponsePayloadCatalogProvidersItemBaseUrlMax),
  "param_aliases": zod.record(zod.string(), zod.string()).optional(),
  "accepted_params": zod.union([zod.array(zod.string()),zod.null()]).optional(),
  "params_closed": zod.boolean().default(getBundleResponsePayloadCatalogProvidersItemParamsClosedDefault)
  ...
  "priority": zod.int(),
  "version": zod.int()
}).describe('A provider credential reference, priority, and version included in a policy bundle.\n\nThe secret value is not included. A version change tells data planes to refresh their cached value.')).default(getBundleResponsePayloadCatalogCredentialsDefault)
