...
TokKeeper has separate credentials for management and inference. They are not interchangeable.
...
```bash
tokkeeper inference-keys create checkout-service --workspace production
```
