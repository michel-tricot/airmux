...
This route accepts Chat Completions or canonical JSON. Official SDK requests are detected from their user-agent and
unambiguous request fields. Raw text-only requests should set `x-tokkeeper-dialect: openai_native`.
