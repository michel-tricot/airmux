...
Chat Completions request can target an Anthropic model. AirLLM returns the response and errors in the caller's dialect.
...
If the public AirLLM origin is `https://llm.example.com`:
