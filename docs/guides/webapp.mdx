...
<Frame caption="Workspace navigation, with workspace and organization pages in the sidebar">
  <img src="../images/webapp-workspace.png" alt="Workspace overview and the workspace and organization menus" />
</Frame>
...
<Frame caption="Organization overview and organization navigation">
  <img src="../images/webapp-organization.png" alt="Organization usage overview with Models, Requests, and Settings in the sidebar" />
</Frame>
...
<Frame caption="Instance overview showing organization and user totals, reporting data planes, and recent activity">
  <img src="../images/webapp-instance.png" alt="Instance overview with Organizations, Users, Management Keys, and Provider Keys in the sidebar" />
</Frame>

<Frame caption="Instance organization list">
  <img src="../images/webapp-instance-organizations.png" alt="Instance Organizations page showing the organization list" />
</Frame>
...
<Note>The screenshots use an isolated demo organization and workspace, so usage totals are empty.</Note>
