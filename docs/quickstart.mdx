---
title: "Quickstart"
description: "Run the full airmux platform, send a real model request, find its cost in the webapp, and enforce your first workspace policy."
---
...
<Steps>
  <Step title="Clone the repository and set a provider key">
    ...
    If port 8080 is already in use on your machine, choose a free port and update `AIRMUX_PUBLIC_URL` in `.env` and
    the loopback port in the next step. Keep this installation local until you have claimed the instance.
  </Step>
  ...
  <Step title="Start the stack">
    ...
    application starts. The loopback binding keeps the unclaimed instance off external interfaces.
