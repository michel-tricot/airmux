...
<Steps>
  ...
  <Step title="Send a request from your own application">
    ...
    **You should see:** HTTP 200 and a `choices[0].message.content` value, plus a `usage` object and a `gateway` object
    ...
    provider key with the inference key. See [OpenAI SDK](/docs/guides/openai-sdk) and
    [Anthropic SDK](/docs/guides/anthropic-sdk).
  </Step>
...
<Columns cols={2}>
  <Card title="Move an existing application" icon="code" href="/docs/guides/openai-sdk">
