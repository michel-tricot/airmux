...
Before publishing the repository, enable and test GitHub private vulnerability reporting. The current private
repository has no verified researcher-facing confidential channel. Keep credentials and exploit details out of public
issues; triage reports through a restricted channel until the reporting path is confirmed.
