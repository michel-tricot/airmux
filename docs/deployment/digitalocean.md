...
Docker network. Run setup as soon as the public route becomes available; until the first account
is created, anyone who can reach the sign-up page can become the instance owner. Open
`https://llm.example.com` to verify the public route.
