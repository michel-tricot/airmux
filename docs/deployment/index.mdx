...
| Shape | Purpose |
| --- | --- |
| airmux | Default full platform on one application host plus Postgres |
...
The image defaults to the `airmux` role. Its container listens on port `8080` and serves the console, `/api/v1`,
