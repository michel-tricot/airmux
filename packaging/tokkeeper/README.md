...
Start with the [quickstart](https://github.com/michel-tricot/airllm/blob/main/docs/quickstart.mdx) or run a
[gateway without a control plane](https://github.com/michel-tricot/airllm/blob/main/docs/deployment/gateway.mdx).

TokKeeper is pre-1.0. Configuration and APIs may change before the first stable release. It is licensed under the
[Elastic License 2.0](https://github.com/michel-tricot/airllm/blob/main/LICENSE).
