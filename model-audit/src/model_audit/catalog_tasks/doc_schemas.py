...
def schema(title: str, source: str, required: list[str], properties: CatalogObject, *, notes: list[str] | None = None) -> CatalogObject:
    ...
    if notes:
        output["x-notes"] = notes
    return output


BUILD: dict[str, CatalogObject] = {}
