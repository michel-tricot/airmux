...
from model_audit.drivers.wire import gateway_options, openai_chat_options, openai_messages, openai_responses_options
...
class OpenAIDriver(ClientDriver):
    ...
    def _responses(client: OpenAI, model: str, case: Case, transport: Transport, connection: Connection) -> Observation:
        ...
        body = alias_params(openai_responses_options(case), connection.param_aliases)
    ...
    def _chat(client: OpenAI, model: str, case: Case, transport: Transport, connection: Connection) -> Observation:
        ...
        body = {
            ...
            **(gateway_options("chat/completions", case) if connection.route == "gateway" else {}),
        }
        body = alias_params(body, connection.param_aliases)
