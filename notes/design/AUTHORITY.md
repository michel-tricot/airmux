...
/api/v1/organizations/{org_id}/workspaces/{workspace_ref}/...
```
...
The first human signup becomes the instance owner. The `tokkeeper control-plane owner` command is the local recovery
