...
- [Append-only schema compatibility](schema-compatibility-migrations.md) — when a shipped Alembic revision was edited after initialization, add a forward migration and attribute audited backfills to root.
